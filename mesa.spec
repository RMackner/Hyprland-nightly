...
%define commit 3570e94bcc187512490ac0871086fb101dc1c9d6
...
Source0:        %{build_repo}/archive/%{commit}/mesa-%{commit}.tar.gz
...
%endif
  ...
  -D valgrind=%{?with_valgrind:enabled}%{!?with_valgrind:disabled} \
  -D build-tests=false \
  -D selinux=true \
  -D lmsensors=enabled \
  -D osmesa=true \
